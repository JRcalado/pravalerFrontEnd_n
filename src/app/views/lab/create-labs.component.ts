...
@Component({
  templateUrl: 'create-labs.component.html'
})
export class CreateLabsComponent implements OnInit{
  ...
  createLabor(){
    ...
    console.log('Cnpj: '+this.formLabTitle);
    console.log('Name: '+this.name);

    let lab = {name:'',cnpj:'',status:0};
        ...
        if(this.formLabTitle != undefined  &&  this.formLabTitle != ''){
          console.log('nao vazio');
          lab.cnpj= this.formLabTitle;
        ...
        if( this.name  != undefined && this.formLabTitle  != undefined ){
            this.showChildModal();
            let labs2 ;
              this.labService.createLab(lab).subscribe((data) => {
              labs2 = data;
              console.log(data);
              this.hideChildModal();

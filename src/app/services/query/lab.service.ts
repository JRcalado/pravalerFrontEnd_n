...
export class LabService {
    ...
    latest(page: number): Observable<any> {
        ...
        return this.authHttp
            ...
            .map((response: any) => response).catch((err) => {
    ...
    get(id: number): Observable<any> {
        ...
        return this.authHttp
            .get(`${environment.API_URL}/api/instituicoes/${id}`);
    ...
    getCursos(id: number): Observable<any> {
      ...
      return this.authHttp
          .get(`${environment.API_URL}/api/cursos/${id}`);

  }

  getAlunos(id: number): Observable<any> {


    return this.authHttp
        .get(`${environment.API_URL}/api/alunosAll/${id}`);
    ...
    getAlternativoCursos(id: number){


      return this.authHttp
          .get(`${environment.API_URL}/api/cursosAll/${id}`)
          .map((response: any) => {
              console.log(response);
              let data = response;
          let lab = data;
    ...
    updateLab(lab): Observable<any> {
      ...
      formData.append('cnpj', lab.cnpj);
      formData.append('status', lab.status);

        return this.authHttp
            .post(`${environment.API_URL}/api/instiedit`,formData)
    ...
    updateCurso(lab): Observable<any> {


      const formData = new FormData();
      formData.append('id', lab.id);
      formData.append('name', lab.name);
      formData.append('duracao', lab.duracao);
      formData.append('status', lab.status)
      formData.append('instituicao_id', lab.instituicao_id);

        return this.authHttp
            .post(`${environment.API_URL}/api/cursoedit`,formData)



    }

    getAlternativoAlunos(id: number){
    ...
    createLab(lab): Observable<any> {
      ...
      .set('name', lab.name)
      .set('cnpj', lab.cnpj)
      .set('status', lab.status);
      const formData = new FormData();

     // formData.append('title', lab.title);

        return this.authHttp
            .post(`${environment.API_URL}/api/instinew`, body.toString(),
            {
    ...
    createCurso(lab): Observable<any> {

      const body = new HttpParams()
      .set('name', lab.name)
      .set('duracao', lab.duracao)
      .set('status', lab.status)
      .set('instituicao_id', lab.instituicao);

        return this.authHttp
            .post(`${environment.API_URL}/api/cursonew`, body.toString(),
            {
              headers: new HttpHeaders()
                .set('Content-Type', 'application/x-www-form-urlencoded')
            }
    ...
    createAluno(lab): Observable<any> {

      const body = new HttpParams()
      .set('name', lab.name)
      .set('cpf', lab.cpf)
      .set('status', lab.status)
      .set('curso_id', lab.curso)
      .set('instituicao_id', lab.id_inst)
      .set('nascimento', lab.nascimento)
      .set('email', lab.email)
      .set('celular', lab.celular)
      .set('endereco', lab.endereco)
      .set('numero', lab.numero)
      .set('bairro', lab.bairro)
      .set('cidade', lab.cidade)
      .set('uf', lab.uf);

        return this.authHttp
            .post(`${environment.API_URL}/api/alunonew`, body.toString(),
            {
              headers: new HttpHeaders()
                .set('Content-Type', 'application/x-www-form-urlencoded')
            }
